...
from app.views import MovieDetailAPIView, MovieListAPIView, RatingDetailAPIView, RatingListAPIView, RaterDetailAPIView, RaterListAPIView
...
urlpatterns = [
    ...
    url(r'^ratings/$', RatingListAPIView.as_view(), name="rating_list_api_view"),
    url(r'^ratings/(?P<pk>\d+)/$', RatingDetailAPIView.as_view(), name="rating_detail_api_view")
